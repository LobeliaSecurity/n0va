    ...
    <>
      ...
      >
        <motion.div variants={staggerItemSubtle}>
          <Card.Root className="rounded-xl border border-slate-200 bg-white shadow-sm">
            <Card.Header className="px-6 pt-6">
              <Card.Title className="text-lg text-slate-900">{t("settings.languageTitle")}</Card.Title>
              <Card.Description className="text-slate-600">{t("settings.languageDesc")}</Card.Description>
            </Card.Header>
        ...
        <motion.div variants={staggerItemSubtle}>
          <Card.Root className="rounded-xl border border-slate-200 bg-white shadow-sm">
            <Card.Header className="px-6 pt-6">
              <Card.Title className="text-lg text-slate-900">{t("ca.dataDirTitle")}</Card.Title>
              ...
              {loading ? (
                ...
                <>
                  <div className="flex flex-col gap-2">
                    <Label.Root className="text-slate-700">{t("common.path")}</Label.Root>
                    <Input.Root value={dataDir} onChange={(e) => setDataDirState(e.target.value)} className="max-w-3xl" />
                  </div>
